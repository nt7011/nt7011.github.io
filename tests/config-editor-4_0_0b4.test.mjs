...
} from "../translator/4.0.0b4/config-editor.mjs";
import {
  createTranslator,
} from "../translator/4.0.0b4/i18n.mjs";

test("4.0.0b4 overrideTranslationRegex editor uses regex replacement rules", () => {
...
test("4.0.0b4 overrideTranslationRegex enforces arrow grammar and regex validity", () => {
  const result = normalizeTranslationRegexReplacementInput(`
    ^NoArrow$
    /bad/g => ignored
  `);
...
test("4.0.0b4 substitutePlaintextBeforeTranslation editor uses plaintext replacement rules", () => {
...
test("4.0.0b4 rule editor localization uses beta copy and Japanese examples", () => {
...
test("4.0.0b4 upgrade defaults backfill hidden and visible beta settings only when missing", () => {
